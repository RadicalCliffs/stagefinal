...
**File:** [src/lib/__tests__/balance-payment-service.test.ts](src/lib/__tests__/balance-payment-service.test.ts#L330)
```
...
```tsx
const response = await fetch(`https://mthwfldcjvpxjtmrqkqm.supabase.co/functions/v1/...`);
```
...
**Files:** [src/components/__tests__/PaymentModal.test.tsx](src/components/__tests__/PaymentModal.test.tsx)
```
