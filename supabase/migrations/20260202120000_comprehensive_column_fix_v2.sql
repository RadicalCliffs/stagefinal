-- =====================================================
-- COMPREHENSIVE FIX V2: ALL Column Reference Errors
-- =====================================================
...
--
-- FIXED: Properly drops ALL function overloads before recreating
-- Date: 2026-02-02
-- =====================================================
...
-- =====================================================
-- PostgreSQL treats functions with different parameter names as different functions
-- We need to drop all possible versions that might exist from previous migrations

-- Drop all versions of get_user_transactions (both parameter name variants)
...
DROP FUNCTION IF EXISTS public.get_user_transactions(TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_user_transactions(user_identifier text) CASCADE;
DROP FUNCTION IF EXISTS get_user_transactions(p_user_identifier text) CASCADE;
DROP FUNCTION IF EXISTS get_user_transactions(TEXT) CASCADE;

-- Drop all versions of get_comprehensive_user_dashboard_entries
...
-- Drop all versions of get_user_competition_entries
...
-- Parameter name: user_identifier (matches production)
-- =====================================================
...
-- Remove ALL non-existent column references
-- Parameter name: p_user_identifier (matches production)
-- =====================================================
...
BEGIN
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Comprehensive fix V2 complete';
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Dropped ALL function overloads with different parameter names';
  RAISE NOTICE 'Created single version of each function:';
  RAISE NOTICE '  - get_user_transactions(user_identifier text)';
  RAISE NOTICE '  - get_comprehensive_user_dashboard_entries(p_user_identifier text)';
  RAISE NOTICE '  - get_user_competition_entries(p_user_identifier text)';
  RAISE NOTICE '';
  RAISE NOTICE 'All column reference errors fixed:';
  RAISE NOTICE '  - Removed all references to ticket_numbers (column does not exist)';
  RAISE NOTICE '  - Changed all transaction_hash references to tx_id (correct column)';
  RAISE NOTICE '';
