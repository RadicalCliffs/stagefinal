-- =====================================================
-- ENHANCE USER COMPETITION ENTRIES RPC
-- =====================================================
-- This migration enhances get_user_competition_entries to return:
-- 1. Individual purchase records (not just aggregated)
-- 2. Competition metadata (status, draw_date, vrf_tx_hash)
-- 3. All data needed for detailed competition entry view
-- =====================================================
...
-- Create enhanced version that returns complete entry data
