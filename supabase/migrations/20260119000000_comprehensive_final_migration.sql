...
CREATE INDEX IF NOT EXISTS idx_joincompetition_wallet_lower ON joincompetition(LOWER(walletaddress));
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(jc.canonical_user_id, jc.walletaddress, '')::text as privy_user_id,
