-- ============================================================================
-- HOTFIX: Recreate allocate_lucky_dip_tickets_batch with competition_id
-- ============================================================================
-- The previous migration dropped competitionid column but the function
-- didn't update properly. This explicitly recreates it.
-- ============================================================================
...
BEGIN
  RAISE NOTICE '========================================================';
  RAISE NOTICE 'HOTFIX: allocate_lucky_dip_tickets_batch recreated';
  RAISE NOTICE 'Now uses competition_id column (not competitionid)';
  RAISE NOTICE '========================================================';
END $$;
