...
async function callCreateCharge(body: Record<string, unknown>): Promise<ChargeResponse> {
  ...
  console.log('[OnchainKit] callCreateCharge raw response:', JSON.stringify(responseData));
  console.log('[OnchainKit] callCreateCharge rawData for normalization:', JSON.stringify(rawData));
  ...
  console.log('[OnchainKit] callCreateCharge normalized data:', JSON.stringify(normalizedData));
