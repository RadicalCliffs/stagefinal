...
const HeroSection = () => {
  return (
    <>
      ...
      <div className="bg-[#3E3E3E] max-w-[77rem] mx-auto pt-6 rounded-b-xl rounded-t-none sm:mt-0 -mt-[11px] relative z-0">
        <div className="mt-1">
          <CardPayments />
        </div>
        <div className="sm:mt-10 mt-6 max-w-[calc(100%*11.5/12)] mx-auto">
          <Partners />
        </div>
