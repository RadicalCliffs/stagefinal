...
const InstantWinCompetition = ({ competition }: CompetitionWrapper) => {
  ...
  useEffect(() => {
    if (initialized && !ticketsLoading) {
      console.log(
        `[InstantWin] Competition ${competition.uid} tickets initialized:`,
        {
    ...
    if (ticketsError) {
      console.error(
        `[InstantWin] Error initializing tickets for ${competition.uid}:`,
        ticketsError,
      );
    }
  ...
  return (
    <div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-[#2A2A2A] rounded-xl p-4 border border-[#404040]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-white sequel-95 text-lg">
                  53 INSTANT WINNERS
                </h3>
                <p className="text-white/60 sequel-45 text-sm">
                  3 Major Prizes + 50 Wallet Credits
                </p>
              </div>
            </div>
            <button
      ...
      <div className="pt-14 pb-20 bg-[#232323] xl:px-0 px-4 relative">
        <Heading
          text="Major Prizes"
          classes="text-white uppercase sequel-95 sm:mb-12 mb-7"
        />
      ...
      <div className="pb-6 xl:px-0 sm:px-4 px-2 relative bg-[#1E1E1E] pt-10">
        <div className="max-w-5xl mx-auto">
          <Heading
            text="Wallet Credits"
            classes="text-white uppercase sequel-95 sm:mb-8 mb-4"
          />
          <p className="text-center text-white/60 sequel-45 text-sm mb-8 -mt-4">
