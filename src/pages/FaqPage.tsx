  ...
  const faqs: FaqItem[] = [
    {
      ...
      answer:
        "ThePrize.io is a crypto-based competition platform where you can win exciting digital prizes and luxury items by entering various competitions using both cryptocurrency and fiat. However, the fiat option will only be available in approved jurisdictions.",
    },
    {
      question: "How do I enter a competition?",
      answer:
        "For single prize comps you can select your own ticket numbers or use our lucky dip function. For instant wins see the next FAQ below. First, ensure you have opened an account on our website. Select how much you wish to top your account up to, to purchase tickets. Then choose the competition you wish to enter. You can also enter a competition directly by pressing ENTER NOW on the comp page. When you have paid your entry fee, you will be told if you have answered the multiple choice question correctly. If you have, you will be entered in the draw with all the other correct entries. If you fail to answer correctly, you will not be entered into the draw. Anyone entering for free will not be told whether they have answered the question correctly and will not receive confirmation that they are entered into the draw. However, all entered ticket numbers are published on the competition pages and therefore all entrants should check this to ensure they have been entered into the draw for the competition they have entered.",
    },
    {
      question: "How do instant wins work?",
      answer:
        "Unlike a single prize comp, instant wins prizes have a ticket number already attached to the prize. These are displayed on the comp page. When you use our lucky dip function and pay for your tickets, you will be notified instantly if you have won and if successful you can claim your prize. Our added bonus is that every ticket purchased -whether it's a win or lose- will be entered into the end prize draw! Prizes will vary across different competitions.",
    },
    {
      question: "Does ThePrize.io have a gambling licence?",
      answer:
        "No, due to the way the platform is structured, we are free from gambling regulations by law in Europe and many other jurisdictions. Please see our Terms & Conditions, Acceptable Use Policy, Privacy Policy and Terms of Use.",
    },
    {
      question: "What cryptocurrencies are accepted?",
      answer:
        "We accept a range of popular cryptocurrencies on networks, including Ethereum (ETH), Base (BASE) and Solana (SOL) with more being added soon.",
    },
    {
      question: "How are winners selected?",
      answer:
        "Our winners are chosen using Chainlink VRF random number generator, ensuring a fair and transparent process verifiable on-chain. You will be able to view the tx hash of the draw on our site, and will be notified if you have won for verification. This ensures fairness and transparency in winner selection.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "For any inquiries or issues, you can reach our customer support team through our Telegram tech support bot, or by emailing us directly at contact@theprize.io.",
    },
    {
      question: "How do I stay updated on new competitions?",
      answer:
        "To stay updated on our latest competitions and announcements, follow us on social media on Telegram, X and Instagram.",
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="sequel-45 text-white/70 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed">
              Find answers to the most common questions about ThePrize.io
              competitions, entries, and prizes.
            </p>
          </div>
