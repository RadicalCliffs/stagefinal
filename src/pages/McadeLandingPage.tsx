/**
 * Metacade / MCADE Landing Page
 *
 * This is the beta launch landing page for theprize.io/mcade
 * It will eventually become the main homepage when stage.theprize.io
 * is swapped to production.
 */
...
const McadeLandingPage = () => {
  // Track mcade source on page load
  useEffect(() => {
    // Store mcade source for analytics tracking
    sessionStorage.setItem("traffic_source", "mcade");
    sessionStorage.setItem(
      "traffic_source_timestamp",
...
export default McadeLandingPage;
