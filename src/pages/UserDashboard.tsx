    ...
    return (
        <>
            ...
            <div className='px-3 sm:px-4 xl:px-0'>
                <p className="text-center xl:max-w-5xl max-w-2xl mt-6 sm:mt-10 mx-auto py-2 sm:py-3 rounded-t-xl bg-[#E5EE00] text-[#181818] sequel-75 uppercase text-sm sm:text-lg xl:text-xl">My Activity</p>
                <DashboardTabs />
            </div>
